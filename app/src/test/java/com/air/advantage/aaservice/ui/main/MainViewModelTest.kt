...
class MainViewModelTest {
    ...
    @Test
    fun connectionState_is_initially_null() =
        runBlocking {
            assertEquals(null, viewModel.connectionState.first())
        }

    @Test
    fun setConnectionState_true_updates_flow() =
        runBlocking {
    ...
    @Test
    fun setConnectionState_false_updates_flow() =
        runBlocking {
    ...
    @Test
    fun multiple_setConnectionState_calls_update_correctly() =
        runBlocking {
            viewModel.setConnectionState(true)
            assertEquals(true, viewModel.connectionState.first())
    ...
    @Test
    fun transportConnectionStatus_defaults_to_idle() =
        runBlocking {
            assertEquals(TransportConnectionStatus.Idle, viewModel.transportConnectionStatus.first())
        }

    @Test
    fun setTransportConnectionStatus_updates_flow() =
        runBlocking {
    ...
    @Test
    fun setTransportConnectionStatus_does_not_affect_connectionState() =
        runBlocking {
            viewModel.setConnectionState(true)
            viewModel.setTransportConnectionStatus(TransportConnectionStatus.Error)
