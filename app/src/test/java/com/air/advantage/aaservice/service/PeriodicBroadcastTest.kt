...
class PeriodicBroadcastTest {
    ...
    @Test
    fun `periodicInfoBroadcast sends no-permission broadcast with correct action and component`() = runBlocking {
    ...
    @Test
    fun `periodicInfoBroadcast no-permission extra is encrypted ByteArray that decrypts to service info`() = runBlocking {
        val noPermIntent = runOnePeriodicIteration()
